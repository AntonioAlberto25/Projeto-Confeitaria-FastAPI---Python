...
- **Botões:** Novo pedido, Nova receita
- **Links:** Pedidos, Receitas, Perfil
- **Considerações:** Exibir KPIs de pedidos do dia, pedidos em produção e pedidos pendentes; priorizar leitura rápida e uso mobile.
...
- **Considerações:** Atualização sem recarregar a página inteira; foco em usabilidade mobile.
...
3. No detalhe do pedido (INT-06), o status é atualizado para Em Produção ou Concluído.

Fluxo mobile-first:
1. Barra de navegação inferior com atalhos: Dashboard, Pedidos, Receitas.
...
- Implementar validação em tempo real para formulários de receita e pedido.
...
- Aplicar cores semânticas para status de pedido.

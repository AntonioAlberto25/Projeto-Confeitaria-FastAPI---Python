...
- `data_inicio_producao` (DateTime, opcional)
...
- Registro: Criação do pedido consome automaticamente o rendimento da receita associada.
- Estorno: Cancelamento do pedido ou redução na quantidade devolve o respectivo rendimento para a receita.
...
**Tabela `pedidos`:** id, cliente_nome, cliente_telefone, descricao, observacoes, tipo_entrega, endereco_entrega, preco_total, data_entrega, user_id, receita_id, status, quantidade, data_criacao, data_inicio_producao, data_conclusao
